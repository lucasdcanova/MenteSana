...
import { Brain, FileText, Lock, Shield, Eye, Database, UserCog, MessageSquare } from "lucide-react";
  ...
  return (
    <div className="pb-20 px-4 space-y-6">
      <div className="mt-4 mb-6 flex items-center justify-between">
        ...
        <IosButton variant="outline" onClick={() => setLocation('/settings')}>
          Voltar
        </IosButton>
      </div>
      ...
      <div className="flex justify-center mt-6">
        <IosButton onClick={() => setLocation('/terms')}>
